...
def convert():
	...
	files = os.listdir("H:/Cocktail party gui/backend/converted_audio/")
	rate1, data1 = wavfile.read('H:/Cocktail party gui/backend/converted_audio/' + files[0])
	rate2, data2 = wavfile.read('H:/Cocktail party gui/backend/converted_audio/' + files[1])
	...
	wavfile.write("H:/Cocktail party gui/backend/converted_audio/separate1.wav", rate1, 5000*S[0].astype(np.int16))
	wavfile.write("H:/Cocktail party gui/backend/converted_audio/separate2.wav", rate2, 5000*S[1].astype(np.int16))
